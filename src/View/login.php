                    ...
                    <form class="uk-grid-small" uk-grid action="login_normal" method="POST">
                        ...
                        <div class="uk-width-1-1@s uk-flex uk-flex-center">
                            ...
                            <div class="uk-inline">
                                ...
                                <input class="uk-input" placeholder="Correo Electronico" type="email" aria-label="Not clickable icon" name="correo" required>
                            </div>
                        </div>
                        <div class="uk-width-1-1@s uk-flex uk-flex-center">
                            <div class="uk-inline">
                                <span class="uk-form-icon" uk-icon="icon: lock"></span>
                                <input class="uk-input" placeholder="Contraseña" type="password" aria-label="Not clickable icon" name="contraseña" required>
                            </div>
                        </div>
                        <div class="uk-width-1-1@s uk-flex uk-flex-center">
                            <div class="uk-inline">
                                <span class="uk-form-icon" uk-icon="icon: question"></span>
                                <input class="uk-input uk-form-blank" placeholder="Codigo" type="text" aria-label="Not clickable icon" name="codigo" autocomplete="off" required>
                            </div>
                        </div>
                        <div id="messageError" style="color: red;"></div>

                        <div class="uk-width-1-1@s uk-flex uk-flex-middle uk-flex-center">
                            <img src="Captcha" alt="" width="150" id="img-codigo">
                    ...
                    <form id="formRegisterUser" class="uk-grid-small uk-flex-center" uk-grid>
                        ...
                        <div class="uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input inpRegisterName" id="form-stacked-text" type="text" placeholder="Nombre" name="nombre"  required>
                            </div>
                        </div>
                        <div class="uk-width-1-2@s">
                            <label class="uk-form-label" for="form-stacked-text">APELLIDO</label>
                            <div class="uk-form-controls">
                                <input class="uk-input inpRegisterLastName" id="form-stacked-text" type="text" placeholder="Apellido" name="apellido" required>
                            </div>
                        </div>
                        <div class="uk-width-1-1@s">
                            <label class="uk-form-label" for="form-stacked-text">CORREO</label>
                            <div class="uk-form-controls">
                                <input class="uk-input inpRegisterMail" id="form-stacked-text" type="email" placeholder="Correo" name="correo" required>
                            </div>
                        </div>
                        <div class="uk-width-1-1@s">

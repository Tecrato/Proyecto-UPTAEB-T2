        ...
        <nav class="uk-background-secondary uk-light" uk-navbar>
            <div class="uk-navbar-left ">
                <ul class="uk-navbar-nav uk-margin-large-left">
                    <li class="uk-margin-small-right Link">
                    ...
                    <li class="uk-margin-small-right Link productos invisible" id="productos">
                        ...
                        <li class="uk-margin-small-right Link proveedores invisible">
                    ...
                    <li class="uk-margin-small-right Link clientes invisible">
                        ...
                        <li class="uk-margin-small-right Link estadisticas invisible">
                    ...
                    <li class="uk-margin-small-right Link ventas invisible" >

        ...
        <nav class="uk-background-secondary uk-light" uk-navbar>
            <div class="uk-navbar-left ">
                <ul class="uk-navbar-nav uk-margin-large-left">
                    ...
                    <li class="uk-margin-small-right Link productos" id="productos">
                        ...
                        <li class="uk-margin-small-right Link proveedores">
                    ...
                    <li class="uk-margin-small-right Link clientes">
                        ...
                        <li class="uk-margin-small-right Link estadisticas">
                    ...
                    <li class="uk-margin-small-right Link ventas" >

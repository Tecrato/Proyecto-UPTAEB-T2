...
if (session_user_rol_num == "1") {
  $(".btn_agg_factura").removeClass("invisible")
} else {
  PermisosG(null, null, "ventas", ".btn_agg_factura", "R")
}
if (session_user_rol_num == "1") {
  $(".checkCredito").removeClass("invisible")
} else {
  PermisosG(null, null, "credito", ".checkCredito", "R")
}
    ...
    success: function (response) {
      ...
      btnCreateFact.addEventListener("click", () => {
        ...
        let json = {
          ...
          monto_final: parseFloat(document.getElementById("totalFact").textContent).toFixed(2).replace(",","."),

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-10-2024 a las 22:59:58
...
(54, 1, '2024-10-01', 3232, '132132', 1),
(69, 1, '2020-01-01', 12345678, 'nose que póner áca', 1),
(70, 1, '2020-01-01', 12345678, 'nose que póner áca', 1),
(73, 1, '2020-01-01', 12345678, 'nose que póner áca', 1),
(74, 1, '2020-01-01', 12345678, 'nose que póner áca', 1),
(75, 1, '2020-01-01', 12345678, 'nose que póner áca', 1),
(76, 1, '2020-01-01', 12345678, 'nose que póner áca', 1);
...
(1, 4, 'saco', 12, 12, 54, '0000-00-00', 11, 31),
(11, 4, '0', 24, 200, 69, '2025-01-01', 20, 480),
(12, 4, '0', 24, 200, 70, '2025-01-01', 20, 480),
(13, 4, '0', 24, 200, 70, '2025-01-01', 20, 480);
...
(4, 1, 1, 1, 1, 'Refrescador', 'producto_Refrescador_Screenshot_1.png', 1, 1000, 200, 0, 1, 0, '123123268788', 1);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `rotacion_inventario`  AS SELECT coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 1) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 1),2),0) AS `Enero`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 2) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 2),2),0) AS `Febrero`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 3) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 3),2),0) AS `Marzo`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 4) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 4),2),0) AS `Abril`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 5) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 5),2),0) AS `Mayo`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 6) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 6),2),0) AS `Junio`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 7) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 7),2),0) AS `Julio`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 8) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 8),2),0) AS `Agosto`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 9) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 9),2),0) AS `Septiembre`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 10) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 10),2),0) AS `Octubre`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 11) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 11),2),0) AS `Noviembre`, coalesce(round((select sum(`p`.`monto`) from (`pagos` `p` join `registro_ventas` `rv` on(`p`.`id_venta` = `rv`.`id`)) where month(`rv`.`fecha`) = 12) / (select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 12),2),0) AS `Diciembre` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `valor_promedio_inventario_mensual`  AS SELECT coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 1),0),0) AS `Enero`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 2),0),0) AS `Febrero`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 3),0),0) AS `Marzo`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 4),0),0) AS `Abril`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 5),0),0) AS `Mayo`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 6),0),0) AS `Junio`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 7),0),0) AS `Julio`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 8),0),0) AS `Agosto`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 9),0),0) AS `Septiembre`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 10),0),0) AS `Octubre`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 11),0),0) AS `Noviembre`, coalesce(round((select sum(`e`.`existencia` * `e`.`precio_compra`) from (`entradas_2` `e` join `entradas` `e2` on(`e2`.`id` = `e`.`id_entradas`)) where month(`e2`.`fecha_compra`) = 12),0),0) AS `Diciembre` ;
